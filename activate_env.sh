...
echo "📦 Django version: $(python -m django --version 2>/dev/null || echo 'Django not found')"
...
# Export the PS1 to show we're in the activated environment
export PS1="(venv) \[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ "
